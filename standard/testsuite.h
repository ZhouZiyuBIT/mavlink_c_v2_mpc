...
static void mavlink_test_quadrotor_state(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("QUADROTOR_STATE") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_QUADROTOR_STATE) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("QUADROTOR_CONTROL_INPUT") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_QUADROTOR_CONTROL_INPUT) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("SENSOR_IMU") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_SENSOR_IMU) != NULL);
#endif
}
